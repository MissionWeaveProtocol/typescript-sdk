...
| 協定提交       | [`33e47ad8a7318f942de77fb72dbb054d85881b40`][protocol-commit] |
| Schema         | 21 個                                                         |
| 一致性測試向量 | 56 個（26 個有效，30 個無效）                                 |
...
<code>KeyResolver</code>，並回傳規範簽署位元組與雜湊、完整文件雜湊、精確受保護時間，以及已解析的金鑰與 Principal 證據。此結果只證明密碼學驗證；首次准入記錄（First-Admission
Record）、Command 新鮮度和授權仍須另外檢查。
