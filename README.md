...
The package contains 21 schemas and 43 conformance vectors: 22 valid and 21
invalid. The manifest is the 44th file in the bundled `conformance` directory.
...
- `conformance/` — the manifest and 43 JSON vectors.
